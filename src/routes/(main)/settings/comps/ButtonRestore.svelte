<script>
   ...
   * @prop {(manifest: BackupManifest) => Promise<void>} [onclick] - Function to call when the button is clicked.
   * @prop {() => Promise<BackupManifest | null>} getBackup - Function to call to get the list of backups.
   */
