...
<svg style="display: none;">
  <symbol id="tasks" viewBox="0 0 640 640" fill="currentColor">
    <path
  ...
  <symbol id="contacts" viewBox="0 0 640 640" fill="currentColor">
    <path
  ...
  <symbol id="back" viewBox="0 0 24 24" fill="currentColor">
    <path d="M20 11H7.83l5.59-5.59L12 4l-8 8 8 8 1.41-1.41L7.83 13H20v-2z" />
  </symbol>
  <symbol
    id="bell"
  ...
  <symbol
    ...
    stroke-linejoin="round"
  >
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12.5 15L7.5 10L12.5 5" />
  </symbol>
  <symbol
    id="chevron-down"
    viewBox="0 0 20 20"
    ...
    stroke-linejoin="round"
  >
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 7.5L10 12.5L15 7.5" />
  </symbol>
  <symbol
    id="chevron-right"
    viewBox="0 0 20 20"
    ...
    stroke-linejoin="round"
  >
    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7.5 15L12.5 10L7.5 5" />
  </symbol>
  <symbol
    id="clock"
    viewBox="0 0 24 24"
  ...
  >
    <path
      d="M16.862 3.487l3.65 3.65a1.5 1.5 0 010 2.121l-9.193 9.193a1 1 0 01-.502.27l-4 1a1 1 0 01-1.263-1.263l1-4a1 1 0 01.27-.502l9.193-9.193a1.5 1.5 0 012.121 0z"
    />
  </symbol>
  <symbol
    id="gallery"
  ...
  <symbol id="home" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round">
    <path d="M3 12l9-9 9 9" />
    <path d="M6 12v7a1 1 0 0 0 1 1h10a1 1 0 0 0 1-1v-7" />
    <path d="M10 21v-6a2 2 0 0 1 2-2h0a2 2 0 0 1 2 2v6" />
  </symbol>
  <symbol id="important" viewBox="0 0 512 512" fill="currentColor">
    <path
  ...
  <symbol id="info" viewBox="0 0 24 24" fill="currentColor">
    ...
    <path d="M12 16v-4m0-4h.01" stroke="currentColor" stroke-width="2" stroke-linecap="round" fill="none" />
  </symbol>
  <symbol id="leave" viewBox="0 0 640 640" fill="currentColor">
    <path
  ...
  <symbol id="loading" viewBox="0 0 24 24" fill="none" stroke="currentColor">
  ...
  <symbol id="mail" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">
    <path
      stroke-linecap="round"
      stroke-linejoin="round"
  ...
  <symbol id="restore" viewBox="0 0 640 640" fill="currentColor">
    <path
  ...
  <symbol id="save" viewBox="0 0 24 24" fill="currentColor">
    <path
      d="M17 3H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7l-4-4zM12 19a2 2 0 1 1 0-4 2 2 0 0 1 0 4zm3-10H5V5h10v4z"
    />
  </symbol>
  <symbol
    id="search"
  ...
  <symbol id="share" viewBox="0 0 640 640" fill="currentColor">
    <path
  ...
  <symbol id="star" viewBox="0 0 24 24" fill="none" stroke="currentColor">
  ...
  <symbol id="sync" viewBox="0 0 512 512" fill="currentColor">
    <g transform="scale(0.80) translate(51.2 51.2)">
      <path
  ...
  <symbol id="xmark" viewBox="0 0 640 640" fill="currentColor">
    <path
  ...
  <symbol id="user-plus" viewBox="0 0 640 640" fill="currentColor">
    <path
  ...
  <symbol id="users" viewBox="0 0 640 512" fill="currentColor">
    <path
  ...
  <symbol id="users-plus" viewBox="0 0 640 512" fill="currentColor">
    <path
      d="M320 16a104 104 0 1 1 0 208 104 104 0 1 1 0-208zM96 88a72 72 0 1 1 0 144 72 72 0 1 1 0-144zM0 416c0-70.7 57.3-128 128-128 12.8 0 25.2 1.9 36.9 5.4-32.9 36.8-52.9 85.4-52.9 138.6l0 16c0 11.4 2.4 22.2 6.7 32L32 480c-17.7 0-32-14.3-32-32l0-32zm521.3 64c4.3-9.8 6.7-20.6 6.7-32l0-16c0-53.2-20-101.8-52.9-138.6 11.7-3.5 24.1-5.4 36.9-5.4 70.7 0 128 57.3 128 128l0 32c0 17.7-14.3 32-32 32l-86.7 0zM472 160a72 72 0 1 1 144 0 72 72 0 1 1 -144 0zM160 432c0-88.4 71.6-160 160-160s160 71.6 160 160l0 16c0 17.7-14.3 32-32 32l-256 0c-17.7 0-32-14.3-32-32l0-16zM575 410H595V445H630V465H595V500H575V465H540V445H575Z"
    />
  </symbol>
  <symbol id="user" viewBox="0 0 640 512" fill="currentColor">
    <path
  ...
  <symbol id="new-group" viewBox="0 0 800 512" fill="currentColor">
    <!-- front person head -->
    <path d="M96 128a128 128 0 1 1 256 0A128 128 0 1 1 96 128" />
    <!-- front person body -->
    <path
      d="M0 482.3C0 383.8 79.8 304 178.3 304l91.4 0C368.2 304 448 383.8 448 482.3c0 16.4-13.3 29.7-29.7 29.7L29.7 512C13.3 512 0 498.7 0 482.3"
    />
    <!-- back person body -->
    <path
      d="M609.3 512l-137.8 0c5.4-9.4 8.6-20.3 8.6-32l0-8c0-60.7-27.1-115.2-69.8-151.8c2.4-.1 4.7-.2 7.1-.2l61.4 0C567.8 320 640 392.2 640 481.3c0 17-13.8 30.7-30.7 30.7"
    />
    <!-- back person head -->
    <path
      d="M432 256c-31 0-59-12.6-79.3-32.9C372.4 196.5 384 163.6 384 128c0-26.8-6.6-52.1-18.3-74.3C384.3 40.1 407.2 32 432 32c61.9 0 112 50.1 112 112s-50.1 112-112 112"
    />
    <!-- plus sign -->
    <path
      d="M700 168c13.3 0 24 10.7 24 24l0 64 64 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-64 0 0 64c0 13.3-10.7 24-24 24s-24-10.7-24-24l0-64-64 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l64 0 0-64c0-13.3 10.7-24 24-24z"
    />
  </symbol>

  <symbol id="sign-out" viewBox="0 0 640 640" fill="currentColor">
    <path
  ...
  <symbol id="send" viewBox="0 0 640 640" fill="currentColor">
    <path
