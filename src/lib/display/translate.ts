...
const translations: Record<"af" | "en", Record<string | symbol, string>> = {
  af: {
    // System defaults
    ...
    enter_contact_email_gmail: "bv. naam@gmail.com",
    contact_name_required: "Kontaknaam is verpligtend",
    contact_email_required: "E-posadres is verpligtend",
    email_must_be_gmail: "Slegs @gmail.com adresse word toegelaat",
    log_in_to_see_contacts: "Teken in om jou kontakte te sien",
    ...
    cannot_delete_default_category: "Jy kan nie die standaard kategorie skrap nie",
    ...
    no_groups_yet: "Nog geen groepe nie",
    no_members_yet: "Nog geen lede nie",
    ...
    confirm_leave_group: "Is jy seker jy wil hierdie groep verlaat?",
    disband_group: "Ontbind groep",
    confirm_disband_group: "Is jy seker jy wil hierdie groep ontbind? Dit kan nie ontgedaan word nie.",
    ...
    contacts: "Kontakte",
    invite_history: "Uitnodiging Geskiedenis",
    no_contacts_yet: "Nog geen kontakte. Stuur 'n uitnodiging om te begin.",
    ...
    notification_time: "Kennisgewingstyd",
    ...
    daily_summary_notification_body: "Kliek om jou daaglikse vordering te sien",
    daily_summary_day_marked_complete: "Dag gemerk as voltooi! 🎉",
    daily_summary_perfect_day: "'n Perfekte dag! Alle take voltooi! 🎉",
    daily_summary_great_work: "Uitstekende werk! 💪",
    daily_summary_good_progress: "Goeie vordering gemaak! 👍",
    daily_summary_keep_streak: "Behou jou dag-reeks! 🔥",
    daily_summary_new_day: "Môre is weer 'n nuwe dag! 🌅",
    daily_summary_week_streak: "'n Week se ongebroke werk! 🏆",
    daily_summary_month_streak: "Maand lank konsekwent! 🎖️",
    daily_summary_legendary_streak: "Legendariese dagreeks! 👑",
    completed_today: "Voltooi vandag",
    still_todo_today: "Nog oor vandag",
    tomorrow_tasks: "Môre se take",
    overdue_tasks: "Agterstallige take",
    view_all_overdue: "Sien agterstallige take",
    day_marked_complete: "Dag gemerk as voltooi",
    all_tasks_complete: "Alle take voltooi!",
    day_streak: "dag-reeks",
    completion_rate: "Voltooiings-koers",
    incomplete: "Onvoltooi",
    go_to_today: "Gaan na vandag",
    previous_day: "Vorige dag",
    next_day: "Volgende dag",
    yesterday: "Gister",
    and_n_more: "+ {{count}} meer",
    ...
    manage_your_subscriptions: "Bestuur jou intekeninge en aankope",
    active_subscriptions: "Aktiewe Intekeninge",
    available_products: "Beskikbare Produkte",
    no_products_available: "Geen produkte beskikbaar nie",
    check_back_later: "Kyk later weer",
    refresh: "Verfris",
    failed_to_load_purchases: "Kon nie aankope laai nie",
    price: "Prys",
    expire_on: "Verval op",
    acknowledged: "Erken",
    active: "Aktief",
    manage_subscription: "Bestuur Intekening",
    subscription_available_on_mobile: "Intekeninge is slegs beskikbaar op mobiele toestelle",
  ...
  en: {
    ...
    enter_contact_email_gmail: "e.g. name@gmail.com",
    contact_name_required: "Contact name is required",
    contact_email_required: "Email address is required",
    email_must_be_gmail: "Only @gmail.com addresses are allowed",
    log_in_to_see_contacts: "Log in to see your contacts",
    ...
    cannot_delete_default_category: "You cannot delete the default category",
    ...
    confirm_disband_group: "Are you sure you want to disband this group? This cannot be undone.",
    ...
    no_contacts_yet: "No contacts yet. Send an invite to get started.",
    ...
    daily_summary_notification_body: "Tap to see your daily progress",
    daily_summary_day_marked_complete: "Day marked as complete! 🎉",
    daily_summary_perfect_day: "Perfect day! All tasks completed! 🎉",
    daily_summary_great_work: "Great work! 💪",
    daily_summary_good_progress: "Good progress made! 👍",
    daily_summary_keep_streak: "Keep your streak going! 🔥",
    daily_summary_new_day: "Tomorrow is a new opportunity! 🌅",
    daily_summary_week_streak: "Week's streak! 🏆",
    daily_summary_month_streak: "Month long consistency! 🎖️",
    daily_summary_legendary_streak: "Legendary streak! 👑",
    completed_today: "Completed today",
    still_todo_today: "Still to do today",
    tomorrow_tasks: "Tomorrow's tasks",
    overdue_tasks: "Overdue tasks",
    view_all_overdue: "View all overdue",
    day_marked_complete: "Day marked as complete",
    ...
    manage_your_subscriptions: "Manage your subscriptions and purchases",
    active_subscriptions: "Active Subscriptions",
    available_products: "Available Products",
    no_products_available: "No products available",
    check_back_later: "Check back later",
    refresh: "Refresh",
    failed_to_load_purchases: "Failed to load purchases",
    price: "Price",
    expire_on: "Expires on",
    acknowledged: "Acknowledged",
    active: "Active",
    manage_subscription: "Manage Subscription",
    subscription_available_on_mobile: "Subscriptions are only available on mobile devices",
